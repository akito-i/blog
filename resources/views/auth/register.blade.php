            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="place" class="col-md-4 col-form-label text-md-right">{{ __('住所（都道府県のみ') }}</label>

                            <div class="col-md-6">
                                <input id="place" type="text" rows='4' class="form-control @error('place') is-invalid @enderror" name="place" value="{{ old('place') }}"  required autocomplete="place" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="profile" type="text" rows='4' class="form-control @error('profile') is-invalid @enderror" name="profile" value="{{ old('profile') }}"  required autocomplete="profile" autofocus></textarea>
